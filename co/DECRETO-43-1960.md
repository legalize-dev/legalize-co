---
title: "Por el cual se crea la Junta Nacional de Clasificación de Espectáculos Cinematográficos"
identifier: "DECRETO-43-1960"
country: "co"
rank: "decreto"
publication_date: "1960-02-12"
last_updated: "1960-02-12"
status: "in_force"
source: "https://www.suin-juriscol.gov.co/viewDocument.asp?id=1810430"
department: "MINISTERIO DE GOBIERNO"
document_status_raw: "Vigente"
gazette_reference: "DIARIO OFICIAL. AÑO XCVI. N. 30156. 12, FEBRERO, 1960. PÁG. 6."
gazette_number: "30156"
gazette_page: "166"
gazette_pdf_page: "6"
subtype: "DECRETO ORDINARIO"
sector: "Interior"
entry_into_force: "1960-01-12"
---
...
- **b)** Nombre del productor o razón social; país en donde fue hecha y nombre del distribuidor dentro de la República;

- **c)** Número de rollos de cada película y número de copias que haya sido producido o introducido al país.
...
- **a)** El número de orden corresponde, para este efecto las clasificaciones serán numeradas progresivamente y se anotarán en un libro de registro que, autorizado por la Junta en pleno, llevará la Secretaría.

- **b)** El título o nombre de la película, con indicación de las demás particularidades que sirvan para identificarla;

- **c)** La clasificación que le corresponda:

- **d)** La constancia del pago de los derechos de clasificación.
...
- **a)** A abstenerse de exhibir o anunciar públicamente películas que no hayan sido clasificadas por la Junta;

- **b)** Abstenerse de exhibir en un mismo espectáculo películas que corresponda a diferentes clasificaciones, o acompañarlas de cortos, avances o documentales que no concuerden con la clasificación de las mimas a menos que el espectáculo se anuncie con la clasificación a la edad mayor correspondiente;

- **c)** A impedir la entrada a los espectáculos cinematográficos de personas menores de edad a la indicada por la respectiva clasificación;

- d) A Abstenerse de emplear medios publicitarios engañosos, tales como anunciar una película con clasificación diferente a la fijada por la Junta o el Comité, o anunciarla sin la respectiva clasificación, o adulterando substancialmente su título, o deformado su contenido.

**<Artículo 18.** No se digitó en diario oficial.>

##### **Artículo 19.** los infractores a lo dispuesto en el artículo anterior serán sancionada según la gravedad de la falta, con multas de quinientos pesos ($500.00) a mil pesos ($1.000.00) por la primera vez; y a cinco mil pesos ($5.000.00) por la segunda vez; y con una multa de diez mil pesos ($10.000.00) y el cierre temporal del salón o teatro donde se haya cometido la infracción, por un término no menor de seis meses. La tercera vez. Podrán igualmente suspenderse las proyecciones que contravengan lo dispuesto en el artículo precedente.
