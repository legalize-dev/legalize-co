---
title: "por el cual se expide el Reglamento de Higiene y Seguridad en las Labores Mineras a Cielo Abierto"
identifier: "DECRETO-2222-1993"
country: "co"
rank: "decreto"
publication_date: "1993-11-05"
last_updated: "1993-11-05"
status: "repealed"
source: "https://www.suin-juriscol.gov.co/viewDocument.asp?id=1420601"
department: "MINISTERIO DE MINAS Y ENERGIA"
document_status_raw: "DEROGADO"
gazette_reference: "DIARIO OFICIAL. AÑO CXXIX. N. 41104. 5, NOVIEMBRE, 1993. PÁG. 8."
gazette_number: "41104"
gazette_page: "8"
gazette_pdf_page: "8"
...
| TABLA NUMERO 1 | TABLA NUMERO 1 |
| --- | --- |
| **Valores límites permisibles para ruido continuo en los lugares de trabajo.** | **Valores límites permisibles para ruido continuo en los lugares de trabajo.** |
...
| TABLA NUMERO 2 | TABLA NUMERO 2 |
| --- | --- |
| **Valores límites permisibles para ruido de impacto.** | **Valores límites permisibles para ruido de impacto.** |
...
| Trabajo exterior con carga solar: | Trabajo exterior con carga solar: |
...
| A. **Posición y Movimiento del Cuerpo** | A. **Posición y Movimiento del Cuerpo** | A. **Posición y Movimiento del Cuerpo** | **Kcal/min** |
| --- | --- | --- | --- |
| Sentado | Sentado | Sentado | 0.3 |
| De pie | De pie | De pie | 0.6 |
| Caminando | Caminando | Caminando | 2.0 - 3.0 |
| Subiendo una pendiente | Subiendo una pendiente | Subiendo una pendiente | agregar 0.8 por metro (yarda) de altura |
| **Estimaciones del metabolismo = (M)** | **Estimaciones del metabolismo = (M)** | **Estimaciones del metabolismo = (M)** | **Estimaciones del metabolismo = (M)** |
| Actividad | M | M | M |
|  | Btu/h | Btu/h | Kcal/h |
| **Trabajo liviano** | **Trabajo liviano** | **Trabajo liviano** | **Trabajo liviano** |
...
| **Trabajo moderado**. | **Trabajo moderado**. | **Trabajo moderado**. | **Trabajo moderado**. |
...
| **Trabajo pesado**. | **Trabajo pesado**. | **Trabajo pesado**. | **Trabajo pesado**. |
...
| **Régimen de trabajo - descanso** | **Carga de trabajo** | **Carga de trabajo** | **Carga de trabajo** |
| --- | --- | --- | --- |
