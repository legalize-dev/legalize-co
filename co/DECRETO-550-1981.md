...
identifier: "DECRETO-550-1981"
country: "co"
rank: "decreto"
publication_date: "1981-03-30"
last_updated: "1981-03-30"
status: "in_force"
source: "https://www.suin-juriscol.gov.co/viewDocument.asp?id=1880945"
department: "MINISTERIO DE OBRAS PÚBLICAS Y TRANSPORTE"
document_status_raw: "Vigente"
gazette_reference: "DIARIO OFICIAL. AÑO CXVII. N. 35731. 30, MARZO, 1981. PÁG. 11."
gazette_number: "35731"
gazette_page: "801"
gazette_pdf_page: "1"
subtype: "DECRETO ORDINARIO"
entry_into_force: "1981-03-06"
---
...
|  |  | Por carpa | COL$ | 50.00 |
| f) | Acondicionamiento de aparejos, plumas, winches y colocación en el sitio primitivo una vez terminada la faena, se cobrará por servicio: | Acondicionamiento de aparejos, plumas, winches y colocación en el sitio primitivo una vez terminada la faena, se cobrará por servicio: | Acondicionamiento de aparejos, plumas, winches y colocación en el sitio primitivo una vez terminada la faena, se cobrará por servicio: | Acondicionamiento de aparejos, plumas, winches y colocación en el sitio primitivo una vez terminada la faena, se cobrará por servicio: |
...
| g) | Cuando los servicios de que trata el presente articula sean prestados en domingos y feriados, tendrán un recargo del 200%, sobre el valor ordinario de las tarifas. Cuando se presten después de las 18:00 horas para Cartagena, Barranquilla, Santa Marta y Tumaco y de las 17:00 horas para Buenaventura, en días ordinarios sea de lunes a sábado, tendrán un recargo del 130%. | Cuando los servicios de que trata el presente articula sean prestados en domingos y feriados, tendrán un recargo del 200%, sobre el valor ordinario de las tarifas. Cuando se presten después de las 18:00 horas para Cartagena, Barranquilla, Santa Marta y Tumaco y de las 17:00 horas para Buenaventura, en días ordinarios sea de lunes a sábado, tendrán un recargo del 130%. | Cuando los servicios de que trata el presente articula sean prestados en domingos y feriados, tendrán un recargo del 200%, sobre el valor ordinario de las tarifas. Cuando se presten después de las 18:00 horas para Cartagena, Barranquilla, Santa Marta y Tumaco y de las 17:00 horas para Buenaventura, en días ordinarios sea de lunes a sábado, tendrán un recargo del 130%. | Cuando los servicios de que trata el presente articula sean prestados en domingos y feriados, tendrán un recargo del 200%, sobre el valor ordinario de las tarifas. Cuando se presten después de las 18:00 horas para Cartagena, Barranquilla, Santa Marta y Tumaco y de las 17:00 horas para Buenaventura, en días ordinarios sea de lunes a sábado, tendrán un recargo del 130%. |
...
| a) | Carga homogénea o miscelánea procedente de un descargue directo: | Carga homogénea o miscelánea procedente de un descargue directo: | Carga homogénea o miscelánea procedente de un descargue directo: | Carga homogénea o miscelánea procedente de un descargue directo: |
| --- | --- | --- | --- | --- |
|  |  | Tonelada peso o tonelada volumen | US$ | 14.00 |
| b) | Carga homogénea o miscelánea procedente de un descargue indirecto: | Carga homogénea o miscelánea procedente de un descargue indirecto: | Carga homogénea o miscelánea procedente de un descargue indirecto: | Carga homogénea o miscelánea procedente de un descargue indirecto: |
|  |  | Tonelada peso o tonelada volumen | US$ | 15.30 |
| c) | Carga a granel solida o liquida procedente de un descargue indirecto y si pierde su condición de granel por haber sido empacada o envasada en cualquier fase de la operación: | Carga a granel solida o liquida procedente de un descargue indirecto y si pierde su condición de granel por haber sido empacada o envasada en cualquier fase de la operación: | Carga a granel solida o liquida procedente de un descargue indirecto y si pierde su condición de granel por haber sido empacada o envasada en cualquier fase de la operación: | Carga a granel solida o liquida procedente de un descargue indirecto y si pierde su condición de granel por haber sido empacada o envasada en cualquier fase de la operación: |
|  | c.1. | Con equipo del terminal: |  |  |
|  |  | Tonelada peso o tonelada volumen | US$ | 15.30 |
|  | c.2. | Con equipo de usuario: |  |  |
|  |  | Tonelada peso o tonelada volumen | US$ | 15.00 |
| d) | Carga a granel solida o liquida procedente de un descargue directo, sin que pierda su condición de granel: | Carga a granel solida o liquida procedente de un descargue directo, sin que pierda su condición de granel: | Carga a granel solida o liquida procedente de un descargue directo, sin que pierda su condición de granel: | Carga a granel solida o liquida procedente de un descargue directo, sin que pierda su condición de granel: |
...
| e) | Vehículos de excursionistas o deportistas que pasen en tránsito por el país. | Vehículos de excursionistas o deportistas que pasen en tránsito por el país. | Vehículos de excursionistas o deportistas que pasen en tránsito por el país. | Vehículos de excursionistas o deportistas que pasen en tránsito por el país. |
...
| d) | Carga a granel liquida o solida excluido el café, destinada a un cargue directo: | Carga a granel liquida o solida excluido el café, destinada a un cargue directo: | Carga a granel liquida o solida excluido el café, destinada a un cargue directo: | Carga a granel liquida o solida excluido el café, destinada a un cargue directo: |
|  | d.1. | Manipulada con equipo del terminal: |  |  |
|  |  | Tonelada peso | COL$ | 136.00 |
|  | d.2. | Manipulada con equipo del usuario: |  |  |
|  |  | Tonelada peso | COL$ | 105.0 |
| e) | Ganado por unidad | COL$ | 91.00 | 91.00 |
...
| a) | Carga de importación, carga en tránsito internacional, transitoria. | Carga de importación, carga en tránsito internacional, transitoria. | Carga de importación, carga en tránsito internacional, transitoria. | Carga de importación, carga en tránsito internacional, transitoria. |
| --- | --- | --- | --- | --- |
